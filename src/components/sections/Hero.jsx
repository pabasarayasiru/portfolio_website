...
import developerImage from "../../../public/developer-portrait.png";

function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-black">
      <RadialBackground variant="hero" />
          ...
          <div className="text-left">
            ...
            <FadeIn delay={100}>
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-normal text-white mb-6 leading-tight">
                Hi, I'm Yasiru Pabasara
              </h1>
            </FadeIn>

            <FadeIn delay={200}>
              <p className="text-lg text-white/70 max-w-[550px] mb-8">
                I am a Computer Science and Engineering undergraduate at the University of Moratuwa with a CGPA of 3.43 and over 1.5+ years of industry experience in software engineering. Through internships, academic projects, and professional development work, I have gained hands-on experience in full-stack development, mobile applications, cloud technologies, and scalable software systems. I enjoy transforming complex problems into practical solutions and am passionate about building reliable, high-quality software that creates real-world impact.
            ...
            <FadeIn delay={400}>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-10 max-w-full">
                {STATS.map((stat, index) => (
                  <div
                    key={index}
                    className="text-left border-r border-white/50 last:border-r-0"
                  >
