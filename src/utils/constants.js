...
export const SOCIAL_LINKS = {
  github: "https://github.com/pabasarayasiru",
  linkedin: "https://www.linkedin.com/in/yasiru-pabasara-164793212/",
  twitter: "",
  dribbble: "",
};

export const STATS = [
  { label: "CGPA", value: "3.43" },
  { label: "GCE A/L ", value: "3A" },
  { label: "Island Rank \nPhysics \nStream  ", value: "443" },
  { label: "Z-Score", value: "2.2422" },
  { label: "GCE O/L", value: "9A" },
];
